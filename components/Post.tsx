...
const Post = () => {
  return (
    <span className="post my-8 py-8 md:px-4 rounded-2xl flex flex-col lg:flex-row justify-between">
      ...
      <div>
        <h2 className="mt-4 text-white font-semibold text-xl font-display leading-8">Post One</h2>
